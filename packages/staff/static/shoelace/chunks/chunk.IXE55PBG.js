...
// _xm1jjf1sz:/Users/jirattikarn/Work/shoelace/src/components/button/button.scss
...
var SlButton = class extends h {
  ...
  render() {
    ...
    const isNuxt = this.nuxt ? true : false;
    const isVue = this.vue ? true : false;
    const interior = y`
...
__decorate([
  e2({type: Boolean, reflect: true})
], SlButton.prototype, "nuxt", 2);
__decorate([
  e2({type: Boolean, reflect: true})
], SlButton.prototype, "vue", 2);
__decorate([
  e2()
