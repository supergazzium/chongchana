...
// _xm1jjf1sz:/Users/jirattikarn/Work/shoelace/src/components/image-comparer/image-comparer.scss
  ...
  handleDrag(event2) {
    ...
    function drag(event3, container, onMove) {
      const move = (event4) => {
        ...
        const y2 = (event4.changedTouches ? event4.changedTouches[0].pageY : event4.pageY) - offsetY;
        onMove(x, y2);
      };
      move(event3);
      const stop = () => {
