...
module.exports = {
  ...
  async callback(ctx) {
    ...
    if (provider === 'local') {
      ...
      // The identifier or mobile is required.
      if (!params.identifier && !params.mobile) {
        return ctx.badRequest(
          null,
          formatError({
            id: 'Auth.form.error.email.provide',
            message: 'Please provide your username or your e-mail or your mobile.',
          })
        );
      }
      ...
      } else if (mobileRegExp.test(params.identifier)) {
