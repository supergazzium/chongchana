                    ...
                    FadeTransition(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Money sent to ${widget.recipientName}',
                            style: TextStyle(
                              fontSize: 14,
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            ...
                            colors: [
                              ChongjaroenColors.secondaryColor.withOpacity(0.9),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          _formatPhone(widget.recipientPhone),
                                          style: const TextStyle(
                                            color: Colors.white70,
                                            fontSize: 13,
                                          ),
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 12),
                            _buildDetailRow('Phone Number', _formatPhone(widget.recipientPhone)),
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'The recipient will receive this amount in their wallet immediately.',
                                style: TextStyle(
      ...
      children: [
        ...
        Flexible(
          child: Text(
            value,
            style: TextStyle(
              color: isHighlighted ? ChongjaroenColors.secondaryColor : Colors.black87,
